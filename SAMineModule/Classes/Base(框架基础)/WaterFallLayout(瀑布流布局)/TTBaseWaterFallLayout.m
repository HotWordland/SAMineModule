...
#import "TTBaseWaterFallLayout.h"

@implementation TTBaseWaterFallLayout
//布局前的准备工作
- (void)prepareLayout {
    [super prepareLayout];
...
- (CGSize)collectionViewContentSize {
    ...
    if ([self.delegate respondsToSelector:@selector(contentSizeCalDone:)]) {
        [self.delegate contentSizeCalDone:CGSizeMake(0, [self.maxYDic[maxIndex] floatValue] + self.sectionInset.bottom)];
    }
