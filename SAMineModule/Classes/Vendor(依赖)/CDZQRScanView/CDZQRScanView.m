...
- (UIView *)maskView{
    if (!_maskView) {
        ...
        if (self.scanCornerRadius > 0) {
            scanBezierPath = [UIBezierPath bezierPathWithRoundedRect:self.scanRect byRoundingCorners:UIRectCornerAllCorners cornerRadii:CGSizeMake(self.scanCornerRadius, self.scanCornerRadius)];
        }
