...
//	if (spin) [spinner startAnimating]; else [spinner stopAnimating];
    	if (smallActivityIndicatorView) [smallActivityIndicatorView startAnimating]; else [smallActivityIndicatorView stopAnimating];
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	if (spinner == nil)
	{
        ...
        smallActivityIndicatorView = [[RTSpinKitView alloc] initWithStyle:RTSpinKitViewStyleArc color:[UIColor colorWithHexString:@"349AEF"]];
        CGFloat size = 25;
        [smallActivityIndicatorView setHidesWhenStopped:false];
        [smallActivityIndicatorView setSize:CGSizeMake(size, size)];
        [smallActivityIndicatorView setSpinnerSize:size];
        smallActivityIndicatorView.layer.timeOffset = 1.0;
	}
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	image.center = spinner.center = smallActivityIndicatorView.center = CGPointMake(imagex, imagey);
	//---------------------------------------------------------------------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	if (self.alpha == 0)
	{
		...
		[UIView animateWithDuration:0.15 delay:0 options:options animations:^{
			...
			hud.alpha = 1;
            if (image.image) {
                [smallActivityIndicatorView setHidden:YES];
            }
            else
            {
                [smallActivityIndicatorView setHidden:NO];
